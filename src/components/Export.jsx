import React, {
  ...
  handleSubmit = async (event) => {
    ...
    try{
      ...
      await this.state.tradable.methods.gold_exporter(id,ipfshash).send({from:this.state.account, gas: 1000000}).then((result)=>{
        console.log("Done");
        this.setState({loading:false});
        alert("The gold has been successfully exported.");
      });
    }
    catch(err)
    {
      ...
      async ipfsupload()
      {
        ...
        await ipfs.add(this.state.buffer,(error,result)=>{
            ...
            else
            {
              ...
              alert("Your QR Code has been successfully published on Filecoin-IPFS Decentralised Storage.");
            }
          });
    ...
    render() {
      ...
      <h1> <font color="black">Gold Export Details</font> </h1> 
      <Segment color = "white" >
      <
      Message attached header = 'Welcome to Gold Export Details Form!'
  ...
  <p></p>
      ...
      primary onClick = {
       ...
       > Publish to Filecoin-IPFS </Button>
