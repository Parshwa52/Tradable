import React, {
  ...
  export default class Import extends Component {
    ...
    onFind (value) {
     ...
     var ipfshash = await this.state.tradable.methods.gold_importer(this.state.id.toString()).call({from: this.state.account});
  ...
  //console.log("encdetails=",this.state.encdetails);
    ...
    handleChange = (event, {
      ...
      async approveImport()
      {
        ...
        await this.state.tradable.methods.verify(this.state.id.toString(),this.state.importinglicense.toString()).send({from:this.state.account, gas: 100000}).then((result)=>{
          console.log("Done");
    ...
    render() {
      ...
      <h1> <font color="black">Gold Import Details</font> </h1> 
      <Segment inverted color = "grey" >
      <
      Message attached header = 'Welcome to Gold Import Verification Form!'
